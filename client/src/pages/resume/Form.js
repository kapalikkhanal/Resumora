...
const Form = ({ onFormSubmit }) => {
    ...
    return (
        <section className="bg-gray-50 dark:bg-gray-900">
            <aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-30 h-full transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
                <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
                    <ul class="space-y-5 font-medium">
                        ...
                        <li>
                            <a href="#personalDetails" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        ...
                        <li>
                            <a href="#profileDetails" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        ...
                        <li>
                            <a href="#educationDetails" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
            ...
            {/* Personal Details  */}
            <div id='personalDetails' className='flex justify-around'>
            ...
            {/* Profile Summary  */}
            <div id='profileDetails' className='flex justify-around'>
                <div className='w-30 md:h-screen'>
                    {/* For side Navigation */}
                </div>
                ...
                <div className='flex flex-col py-10 h-screen'>
                    ...
                    <form onSubmit={formik.handleSubmit} className="space-y-5 ">
                        {/* First and Last Name */}
                        <div>
                            <label for="firstName" className="text-center block mb-2 text-xl font-bold dark:text-white">Profile</label>
                            <p className='w-96 text-center block mb-2 text-semibold font-mono dark:text-white'>Write short sentences to interest the reader. Mention your role, experience,your achievements, best qualities and skills.</p>
                            <input onChange={formik.handleChange} value={formik.values.firstName} name="firstName" className="w-96 h-52 border border-gray-900 text-gray-900 sm:text-sm rounded-lg focus:ring-white focus:border-white p-2.5 dark:bg-gray-900 dark:border-gray-700 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue" />
                        </div>
                    </form>
                </div>
            </div>
            ...
            {/* Education Details  */}
            <div id='educationDetails' className='flex justify-around'>
                <div className='w-30 md:h-screen'>
                    {/* For side Navigation */}
                </div>
                {/* Actual Form Data  */}
                <div className='flex flex-col py-10 h-screen'>
                    ...
                    <form onSubmit={formik.handleSubmit} className="space-y-5">
                        ...
                        <div className='flex justify-between space-x-5 '>
                            {/* Name  */}
                            <div>
                                <label for="school" className="text-center block mb-2 text-semibold font-small dark:text-white">School</label>
                                <input onChange={formik.handleChange} value={formik.values.school} name="school" className="border border-gray-900 text-gray-900 sm:text-sm rounded-lg focus:ring-white focus:border-white block w-full p-2.5 dark:bg-gray-900 dark:border-gray-700 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue" />
                            </div>
                            {/* Address  */}
                            <div>
                                <label for="degree" className="text-center block mb-2 text-semibold font-small text-gray-900 dark:text-white">Degree</label>
                                <input onChange={formik.handleChange} value={formik.values.degree} name="degree" className="bg-gray-50 border border-gray-900 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-900 dark:border-gray-700 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue" />
                            </div>
                        </div>
                        <div className='flex justify-between space-x-5 '>
                            {/* Name  */}
                            <div>
                                <label for="startDate" className="text-center block mb-2 text-semibold font-small dark:text-white">Start Date</label>
                                <input onChange={formik.handleChange} value={formik.values.startDate} name="startDate" className="border border-gray-900 text-gray-900 sm:text-sm rounded-lg focus:ring-white focus:border-white block w-full p-2.5 dark:bg-gray-900 dark:border-gray-700 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue" />
                            </div>
                            {/* Address  */}
                            <div>
                                <label for="endDate" className="text-center block mb-2 text-semibold font-small text-gray-900 dark:text-white">End Date</label>
                                <input onChange={formik.handleChange} value={formik.values.endDate} name="endDate" className="bg-gray-50 border border-gray-900 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-900 dark:border-gray-700 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue" />
                            </div>
                        </div>
                        <div>
                            <label for="discription" className="text-center mb-2 block text-semibold font-small text-gray-900 dark:text-white">Discription</label>
                            <input type='email' onChange={formik.handleChange} value={formik.values.discription} name="discription" className="w-96 h-52 bg-gray-50 border border-gray-900 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block p-2.5 dark:bg-gray-900 dark:border-gray-700 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue" />
                        </div>
                        <div>

                            <button type="submit" className="w-full text-white bg-gray-800 hover:bg-[#2f4454] focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">+ Add Another Education</button>
                        </div>
                    </form>
                </div>
            </div>
